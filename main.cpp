...
int main()
{
    ...
    sf::Vector2f buttonPos2(250.f, 900.f);
    sf::Vector2f buttonPos3(500.f, 900.f);
    sf::Vector2f buttonPos4(750.f, 900.f);
    ...
    buttonText3.setPosition(buttonPos2.x + 10.f, buttonPos2.y + 10.f);

    sf::Text buttonText4("Pause", font);
    buttonText4.setCharacterSize(20);
    buttonText4.setPosition(buttonPos2.x + 10.f, buttonPos2.y + 10.f);
    ...
    buttonText1.setPosition(button1.getPosition() + button1.getSize()/2.0f);
    ...
    buttonText2.setPosition(button2.getPosition() + button2.getSize()/2.0f);

    sf::FloatRect textRect3 = buttonText1.getLocalBounds();
    buttonText3.setOrigin(textRect1.left + textRect1.width/2.0f, textRect1.top  + textRect1.height/2.0f);
    buttonText3.setPosition(button1.getPosition() + button1.getSize()/2.0f);
    
    sf::FloatRect textRect4 = buttonText2.getLocalBounds();
    buttonText4.setOrigin(textRect2.left + textRect2.width/2.0f, textRect2.top  + textRect2.height/2.0f);
    buttonText4.setPosition(button2.getPosition() + button2.getSize()/2.0f);
